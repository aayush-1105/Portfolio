...
/* Monochrome GitHub mark (uses currentColor). */
...
/* Monochrome LinkedIn mark (uses currentColor). */
...
/* Minimal monochrome LeetCode glyph (uses currentColor). */
export function LeetCodeIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M13.5 3 6.2 10.4a2.2 2.2 0 0 0 0 3.1L13.5 21" />
      <path d="M16.5 17.2 13.1 20.6" />
      <path d="M8.8 12h9.4" />
    </svg>
  )
}
